...
function loadVideo(videoId, lectureTitle, subjectName = '') {
    ...
    newIframe.src = `https://www.youtube.com/embed/${videoId}?origin=https://plyr.io&enablejsapi=1&widgetid=1&vq=maxresdefault&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3`;
