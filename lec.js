...
function loadVideo(videoId, lectureTitle, subjectName = '') {
    ...
    newIframe.src =   `https://www.youtube.com/embed/${videoId}?` +   `origin=https://plyr.io&` +   `enablejsapi=1&` +   `rel=0&` +           // Already present   `playsinline=1&` +   `cc_load_policy=1&` +   `autoplay=1&` +   `controls=0&` +   `fs=0`;
